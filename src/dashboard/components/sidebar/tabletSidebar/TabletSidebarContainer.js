...
class TabletSidebarContainer extends Component {
    ...
    render() {
        ...
        return <TabletSidebar homeItems={homeItems} isActive={this.isActive} />;
    }
}
...
export default connect(null, mapDispatchToProps)(TabletSidebarContainer);
TabletSidebarContainer.propTypes = {
    activeMenuItem: PropTypes.func
};
TabletSidebarContainer.defaultProps = {
    activeMenuItem: null
};
